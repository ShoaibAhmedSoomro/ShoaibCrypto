...
<body class="">
	...
	<div class="col">
	    <ul style="padding-left:0px;">
	    	<li><small class="text-top-small"><span>Market Cap</span> <?php echo strtok($convertSymbol, " ");?><?php echo number_format($totalCap/$convertRate);?></small></li>
	        <li><small class="text-top-small"><span>24h Volume</span> <?php echo strtok($convertSymbol, " ");?><?php echo number_format($totalvol/$convertRate);?></small></li>
	        <li><small class="text-top-small"><span>BTC Market Cap</span> <?php echo strtok($convertSymbol, " ");?><?php echo number_format($btcCap/$convertRate);?></small></li>
	        <li><small class="text-top-small"><span>BTC Dominance</span> <?php echo number_format($btcCap/$totalCap*100, 1);?>%</small></li>
	    </ul>
    </div>
