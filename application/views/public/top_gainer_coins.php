...
<!-- Data Table  -->
<div class="container">
        <div class="alert alert-success" role="alert">Which crypto coins have gained the most in the last 24 hours? The cryptocurrency list below will be updated in real time and shows you the Top 50 crypto gainers for today.</div>
  <div class="row justify-content-center">
    <div class="col-md-12 text-left">
      <div class="py-2">
        ...
        <tbody>
		 <?php
		  $cnt=0;
             ...
             foreach ($coinChange24DesSort as $key => $value)
				{
				    $img_src=base_url().'assets/images/coins/'.$coinId[$key].'.png';
			        $file_path=FCPATH.'assets/images/coins/'.$coinId[$key].'.png';
			        if (!file_exists($file_path)) $img_src=base_url().'assets/images/default.png';
					if($cnt > 49) continue;
					 ?>
				<tr id="BTC_<?php echo $coinCode[$key];?>">
					<td><?php echo $coinRank[$key];?></td>
					<td><img src="<?php echo $img_src ?>"><a href="<?php echo base_url() ?>coin/<?php echo strtolower(str_replace(' ','-',$coinName[$key])); ?>"><span class="coin-name"><?php echo $coinName[$key];?></span></a> <span class="badge badge-warning"><?php echo $coinCode[$key];?></span></td>
					...
					<td data-sort="<?php echo $coinChange24[$key];?>"><span class="p-up"><i class="fa fa-caret-up"></i> <?php echo round ($coinChange24[$key],2);?>%</span></td>
				</tr>
		 <?php ++$cnt;
		}
				?>
