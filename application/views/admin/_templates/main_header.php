...
?>
            <header class="main-header">
                <a href="<?php echo site_url('admin/dashboard'); ?>" class="logo">
                    ...
                    <span class="logo-lg"><b>FYP</b>2K20/CSME/37</span>
                </a>
...
<?php if ($admin_prefs['user_menu'] == TRUE): ?>
                            ...
                            <li class="dropdown user user-menu">
                                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                    <img src="<?php echo base_url($avatar_dir . '/vector.png'); ?>" class="user-image" alt="User Image">
                                    <span class="hidden-xs"><?php echo "Shoaib Ahmed Soomro"; ?></span>
                                </a>
                                <ul class="dropdown-menu">
