...
?>
            ...
            <footer class="main-footer">
                ...
                <strong><?php echo "PROJECT ID: 0000000"; ?><span style="float:right;">Final Year Project ♥ by <a href="mailto:soomro.shoaibahmed@gmail.com" target="_blank">Shoaib Ahmed Soomro</a> (2K20/CSME/37).</span>
            </footer>
        </div>
